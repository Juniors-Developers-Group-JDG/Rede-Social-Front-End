...
function Section({ children }: React.HTMLProps<HTMLDivElement>) {
  return (
    <section className=" h-fit w-full border-b border-t border-blue-800 bg-black-900 pl-5 pr-7 pt-[11px] lg:w-full lg:border-none">
      <div className="flex flex-row">
        ...
        <div className="ml-[10px] mt-3 flex w-full flex-row justify-between lg:mt-4">
          ...
          <div className="flex flex-row gap-2 self-start pt-[5px] lg:pt-0 ">
      ...
      <div className="mb-3 ml-9 mt-[9px] flex flex-row lg:ml-12 ">
        ...
        <Image
          className="ml-[25px] mr-[5px] lg:ml-10"
          src={chatBuble}
